...
class TestForm(forms.Form):
    ...
    radio_choices = forms.CharField(min_length=7,widget=forms.RadioSelect(choices=SOME_CHOICES)) 
    checkbox_choices = forms.CharField(min_length=7,widget=forms.CheckboxSelectMultiple(choices=SOME_CHOICES)) 
